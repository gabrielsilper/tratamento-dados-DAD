CREATE TABLE estados (
    codigo_ibge VARCHAR(5) PRIMARY KEY,
    sigla_uf VARCHAR(3) NOT NULL UNIQUE,
    unidade_federativa VARCHAR(30) NOT NULL
);

INSERT INTO
    estados (sigla_uf, unidade_federativa, codigo_ibge)
VALUES
    ('AC', 'Acre', '12'),
    ('AL', 'Alagoas', '27'),
    ('AP', 'Amapá', '16'),
